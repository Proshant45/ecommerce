...
Route::post('/cart/{slug}', [CartController::class, 'addToCart'])->name('cart.add');
Route::patch('/cart/{slug}', [CartController::class, 'updateCart'])->name('cart.update');
Route::delete('/cart/{slug}', [CartController::class, 'removeFromCart'])->name('cart.remove');
