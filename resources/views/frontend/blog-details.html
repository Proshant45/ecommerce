...
<body>
  ...
  <!-- header-area end -->
                            ...
                            <ol class="comments">
                                <li class="comment even thread-even depth-1">
                                    <div class="comment-wrap">
                                        <div class="comment-theme">
                                            <div class="comment-image">
                                                <img src="{{asset('assets')}}/images/comment/1.png" alt="Jhon">
                                            </div>
                                        </div>
                                    ...
                                    <div class="comment-wrap">
                                        <div class="comment-theme">
                                            <div class="comment-image">
                                                <img src="{{asset('assets')}}/images/comment/2.png" alt="Jhon">
                                            </div>
                                        </div>
                                        <div class="comment-main-area">
                                            <div class="comment-wrapper">
                                    ...
                                    <div class="comment-wrap">
                                        <div class="comment-theme">
                                            <div class="comment-image">
                                                <img src="{{asset('assets')}}/images/comment/3.png" alt="Jhon">
                                            </div>
                                        </div>
                                        <div class="comment-main-area">
                                            <div class="comment-wrapper">
    ...
    <!-- mouse_scroll.js -->
    <script src="{{asset('assets')}}/js/mouse_scroll.js"></script>
    <!-- scrollup.js -->
...
<!-- Mirrored from themepresss.com/tf/html/tohoney/blog-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 13 Mar 2020 03:35:43 GMT -->
</html>
